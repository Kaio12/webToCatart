...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 79.0, 523.0, 51.0, 22.0 ],
					"text" : "attack 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 458.0, 679.0, 50.0, 22.0 ],
					"text" : "313 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 928.0, 199.0, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 257.0, 41.0, 95.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 229.0, 39.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1010.0, 272.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
,
					"patching_rect" : [ 12.0, 322.0, 94.0, 22.0 ],
					"text" : "p parserOsc"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 359.0, 68.0, 22.0 ],
					"text" : "s effectPos"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 240.0, 90.0, 22.0 ],
					"text" : "loadmess open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 266.0, 51.0, 22.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.0, 808.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 379.0, 67.0, 150.0, 33.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 117.0, 194.0, 41.0, 22.0 ],
									"text" : "delete"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 117.0, 287.0, 24.0, 24.0 ]
								}
...
,
					"patching_rect" : [ 12.0, 295.0, 45.0, 22.0 ],
					"text" : "p node"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 181.0, 774.0, 53.0, 78.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 126.0, 742.0, 52.0, 22.0 ],
					"text" : "r~ effect"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 205.0, 659.0, 60.0, 22.0 ],
					"text" : "s~ concat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 73.0, 91.0, 51.0, 22.0 ],
					"text" : "pcontrol"
				}
...
,
					"patching_rect" : [ 73.0, 120.0, 54.0, 22.0 ],
					"text" : "p effects"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 65.0, 90.0, 22.0 ],
					"text" : "loadmess open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 93.0, 51.0, 22.0 ],
					"text" : "pcontrol"
				}
...
,
					"patching_rect" : [ 11.0, 120.0, 53.0, 22.0 ],
					"text" : "p record"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 629.0, 244.0, 190.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 230.0, 511.0, 55.0, 22.0 ],
					"text" : "s marker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 572.0, 29.0, 22.0 ],
					"text" : "thru"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 784.0, 302.0, 59.0, 22.0 ],
					"text" : "r toimubu"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 205.0, 439.0, 71.0, 32.0 ]
				}
...
,
					"patching_rect" : [ 257.0, 406.0, 59.0, 22.0 ],
					"text" : "p urne"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 857.0, 302.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 570.0, 206.0, 233.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 570.0, 272.0, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 570.0, 242.0, 55.0, 22.0 ],
					"text" : "r alldone"
				}
...
,
					"patching_rect" : [ 228.0, 93.0, 55.0, 22.0 ],
					"text" : "p calculs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 635.0, 302.0, 137.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.0, 302.0, 65.0, 22.0 ],
					"text" : "getdomain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.0, 538.0, 84.0, 22.0 ],
					"text" : "bufferindex $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 121.0, 283.0, 86.0, 22.0 ],
					"text" : "route foremost"
				}
...
,
					"patching_rect" : [ 228.0, 156.0, 87.0, 22.0 ],
					"text" : "p imubu-setup"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 571.0, 116.0, 104.0, 44.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 310.0, 104.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 246.0, 68.000007629394531, 22.0 ],
					"text" : "pvar imub"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "view 7 interface scatterplot"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 126.0, 799.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 538.0, 91.0, 22.0 ],
					"text" : "markerindex $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 428.0, 444.0, 84.0, 22.0 ],
					"text" : "selected 4 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 405.0, 406.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 318.0, 511.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 338.0, 80.000007629394531, 22.0 ],
					"text" : "select $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 269.0, 94.000007629394531, 22.0 ],
					"text" : "columns $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 243.0, 55.000007629394531, 22.0 ],
					"text" : "pak 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 235.0, 302.0, 76.000007629394531, 22.0 ],
					"text" : "route move"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 235.0, 276.0, 82.000007629394531, 22.0 ],
					"text" : "route mouse"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 230.0, 372.0, 282.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"cursor_visible" : 1,
					"dirtypatcher" : 1,
					"domain_bounds" : [ 248.369929807540672, 8239.093207279836861 ],
					...
					"outputviewname" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 562.0, 336.0, 849.0, 467.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1010.0, 306.0, 153.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 214.5, 569.921875, 540.44921875, 569.921875, 540.44921875, 191.2890625, 579.5, 191.2890625 ],
					"order" : 0,
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 305.5, 198.65625, 347.5, 198.65625 ],
					"source" : [ "obj-64", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-54", 0 ],
					"midpoints" : [ 237.5, 188.55078125, 571.5, 188.55078125 ],
					"source" : [ "obj-64", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-123", 1 ],
					"midpoints" : [ 96.5, 416.01953125, 240.5, 416.01953125 ],
					"source" : [ "obj-95", 1 ]
				}
