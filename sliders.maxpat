...
,
		"classnamespace" : "box",
		"rect" : [ -1830.0, 158.0, 1414.0, 790.0 ],
		"gridsize" : [ 15.0, 15.0 ],
		"boxes" : [ 			{
				"box" : 				{
					"id" : "obj-7",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 566.0, 42.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 236.0, 383.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 366.0, 381.0, 32.0, 22.0 ],
									"text" : "print"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 226.0, 307.0, 163.0, 22.0 ],
									"saved_object_attributes" : 									{
										"autostart" : 0,
										"defer" : 0,
										"node_bin_path" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 99.0, 149.0, 77.0, 22.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 14.0, 116.0, 55.0, 22.0 ],
									"text" : "r alldone"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 14.0, 149.0, 75.0, 22.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 10.0, 12.0, 75.0, 22.0 ],
									"text" : "exportPoints"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 14.0, 186.0, 91.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 430.0, 272.0, 509.0, 438.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 992.0, 541.0, 485.0, 22.0 ],
									"text" : "writetrack audio /Users/philippecaillot/Documents/programmation/geste/audiofiles/enr.wav"
								}
...
, 			{
				"box" : 				{
					...
					"text" : "domain bounds 5651.469383 10114.383408"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 458.0, 658.0, 35.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"cursor_position" : [ 7769.366233188019578, 0.082210341488163 ],
					"cursor_shape" : "cross",
					"cursor_size" : 4,
					"cursor_sizeunit" : 0,
					...
					"cursor_visible" : 1,
					"dirtypatcher" : 1,
					"domain_bounds" : [ 5651.469382676555142, 10114.383407678473304 ],
